  ...
  return (
    <div className='navbar bg-bgNavbar p-[16px] md:py-[16px] md:px-[32px] flex justify-between items-center shadow-custom '>
        ...
        <div className="navbar-links flex md:gap-[32px] gap-[16px]">
            ...
            <Link to="/" className='nav-link text-[20px] md:py-[8px] md:px-[16px] p-[8px] border-[4px] border-black text-white transition-colors duration-200
 hover:bg-hoverColor'>Home</Link>
            <Link to="/favorites" className='nav-link text-[20px] md:py-[8px] md:px-[16px] p-[8px] border-[4px] border-black text-white transition-colors duration-200
